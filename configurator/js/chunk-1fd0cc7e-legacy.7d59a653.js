            ...
            var o = function() {
                ...
                L = n["a"].extend({
                    ...
                    computed: {
                        ...
                        showSaveDraftButton() {
                            var t;
                            return Object(E["y"])(null === (t = this.$store.state.uiState.initData.buttons) || void 0 === t ? void 0 : t[_["a"].SAVEDRAFT])
                        }
                    },
                    methods: {
                        async saveDraft() {
                        ...
                        async requestProduct() {
                            await Object(x["c"])(this.$embeddingCallbacks, this.$sdkConnector, this.$store)
                        }
                    }
                }),
                R = L,
...
//# sourceMappingURL=chunk-1fd0cc7e-legacy.7d59a653.js.map