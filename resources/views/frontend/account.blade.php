          ...
          <div class="row">
              <div class="col-lg-3 col-md-4 dashboard_menu-wrap">
                  <div class="dashboard_menu">
                      <ul class="nav nav-tabs flex-column" role="tablist">
                        <li class="nav-item">
                          <a class="nav-link @if( ! app('request')->input('tab') == 'password' ) active @endif" id="dashboard-tab" data-toggle="tab" href="#dashboard" role="tab" aria-controls="dashboard" aria-selected="false"><i class="ti-layout-grid2"></i>Account details</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                          <a class="nav-link @if( app('request')->input('tab') == 'password' ) active @endif" id="change-password-tab" data-toggle="tab" href="#change-password" role="tab" aria-controls="change-password" aria-selected="true"><i class="ti-id-badge"></i>Change Password</a>
                        </li>
                        <li class="nav-item">
              ...
              <div class="col-lg-9 col-md-8">
                  <div class="tab-content dashboard_content">
                      <div class="tab-pane fade @if( ! app('request')->input('tab') == 'password' ) active show @endif" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                    ...
                    <div class="tab-pane fade @if( app('request')->input('tab') == 'password' ) active show @endif" id="change-password" role="tabpanel" aria-labelledby="change-password-tab">
