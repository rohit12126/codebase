            ...
            <div class="col-lg-2 mb-5 mb-lg-0">
                <div class="blog-sticky">
                    ...
                    <div class="collapse" id="shareIcons">
                        <a target="_blank" class="blog-back-btn d-block fb-icon" role="button" data-sharer="facebook" data-title="This is share from custom closet blog to twitter" data-hashtags="hashtag comma separated" data-url="blog-view.php" href="https://www.facebook.com/sharer.php?u=${{url()->current()}}&t=">
                            <img src="{{URL::asset('/images/facebook.svg')}}" alt="">
                            Facebook
                        </a>
                        <a target="_blank" class="blog-back-btn d-block twitter-icon" role="button" data-sharer="twitter" data-title="This is share from custom closet blog to twitter" data-hashtags="hashtag comma separated" data-url="blog-view.php" href="https://twitter.com/intent/tweet?text={{url()->current()}}">
