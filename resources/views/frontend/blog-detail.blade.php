            ...
            <div class="col-lg-2 mb-2 mb-lg-0">
                <div class="blog-sticky">
                    ...
                    <div class="collapse" id="shareIcons">
                        <a target="_blank" class="blog-back-btn d-block fb-icon" role="button" data-sharer="facebook" data-title="This is share from Custom Door and Mirrors blog to twitter" data-hashtags="hashtag comma separated" data-url="blog-view.php" href="https://www.facebook.com/sharer/sharer.php?u={{url()->current()}}&t=" onclick="window.open('https://www.facebook.com/sharer/sharer.php?u={{url()->current()}}&t=', 
                            'newwindow', 
                            ...
                            <a target="_blank" class="blog-back-btn d-block twitter-icon" role="button" data-sharer="twitter" data-title="This is share from Custom Door and Mirrors blog to twitter" data-hashtags="hashtag comma separated" data-url="blog-view.php" href="https://twitter.com/intent/tweet?text={{$blog->title}}&url={{url()->current()}}" onclick="window.open('https://twitter.com/intent/tweet?text={{$blog->title}}&url={{url()->current()}}', 
                                'newwindow', 
                                'width=600,height=550'); 
                            return false;">
