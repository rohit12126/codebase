...
@section('content')
    <section class="section">
        <div class="container">
            <h1 class="pt-3 pb-4 mb-5 heading_s3 text-center">Privacy Policy</h1>
            <div class="terms-conditon-content">
                ...
                <p class="pl-sm-5">
                    ...
                    <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Custom Door & Mirror, 148 Milbar Blvd, Farmingdale, NY 11735. <br>
                    ...
                    <strong>Facebook Fan Page</strong> is a public profile named Custom Door and Mirror specifically created by the Company on the Facebook social network, accessible from <a href="https://www.facebook.com/CustomDoorAndMirror" target="_blank">https://www.facebook.com/CustomDoorAndMirror</a><br>
                    ...
                    <strong>Third-party Social Media Service</strong> refers to any website or any social network website through which a User can log in or create an account to use the Service.<br>
                    ...
                    <strong>Website</strong> refers to Custom Door & Mirror, accessible from www.paniflex.com<br>
                ...
                <h2 class="content-heading">Collecting and Using Your Personal Data</h2>
                ...
                <p class="pl-sm-5">
                    ...
                    Type: Persistent Cookies <br>
                    Administered by: Third-Partie <br>
                ...
                <h2 class="content-heading">Detailed Information on the Processing of Your Personal Data</h2>
                <p>
