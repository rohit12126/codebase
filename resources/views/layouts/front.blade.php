...
<head>
    ...
    <!-- SITE TITLE -->
    <title>Custom Door and Mirrors</title><!-- Favicon Icon -->
                ...
                <span class="head-shop-icon head-user-name">
                    ...
                    @auth
                        <a href="{{url('/account')}}" title="{{ $userData->name ?? ''}}">
                            <img src="{{URL::asset('/images/icon/user.png')}}" alt="">
                            <label class="mb-0">{{ ucwords($userData->name ?? '')}}</label>
                        </a>
                    @endauth
                </span>
                ...
                <nav class="head-nav">
                    <ul class="head-nav-ul mt-lg-1 mr-lg-3">
                        <li class="head-nav-li">
                            <a href="{{ url('installation-video/') }}" class="head-nav-link {{ request()->is('installation-video') ? 'active' : ''}}">Installation Videos</a>
                        </li>
                        <li class="head-nav-li">
                            <a href="{{ url('product/') }}" class="head-nav-link {{ request()->is('product*') ? 'active' : ''}} ">Products</a>
                        </li>
                        <li class="head-nav-li">
                            <a href="{{ url('clients/') }}" class="head-nav-link {{ request()->is('clients*') ? 'active' : ''}} ">Clients</a>
                        </li>
                        <li class="head-nav-li">
      ...
      <div class="auth-modal modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header border-bottom-0 p-0 position-realtive">
            <!-- <h4 class="modal-title" id="exampleModalLabel">Custom Door and Mirrors</h4> -->
            ...
            <div class="post-footer text-center text-sm-left">
                <div class="row m-0">
                    <div class="col-sm-5 p-lg-0">
                        ...
                        <a href={{ url('/')}}><span class="footer-logo">Custom Door and Mirrors</span></a>
                    </div>
...
function myFunction(id) {
    ...
    if (dots.style.display === "none") {
        ...
        document.getElementById("c-arrow"+id).className = "linearicons-arrow-down";
        moreText.style.display = "none";
    } else {
        dots.style.display = "none";
        btnText.textContent = "hide details";
        document.getElementById("c-arrow"+id).className = "linearicons-arrow-up";
